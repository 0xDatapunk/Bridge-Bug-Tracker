...
| <div style="width:290px">Date</div>  | Protocol | Funds At Risk | Root Cause | References | Code to Reproduce |
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
...
# <a name="Confirmed-Bug-Bounties-header">Confirmed Bug Bounties</a>
 ...
 | <div style="width:290px">Date</div>  | Protocol | References | Vuln | Exploit |
| ------------- | ------------- | ------------- | ------------- | ------------- |
