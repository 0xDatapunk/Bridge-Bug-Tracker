...
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
| 2023-06-01 | [PolyNetwork](https://github.com/polynetwork/docs) | $4.4M | <details><summary>compromised 3-of-4 multisig</summary>*the root cause was not a logical bug on the smart contract, but, most likely, stolen (or misused) private keys of 3 out of 4 of Poly network's keepers (off-chain systems controlled by the team)*</details> | [debaud](https://dedaub.com/blog/poly-chain-hack-postmortem) | N/A |
...
* **SoK: Security and Privacy of Blockchain Interoperability** by Augusto A. et al., [video]([https://github.com/spearbit/portfolio/blob/master/content/bridges/BridgeSecurityIntroduction.md](https://www.youtube.com/watch?v=xFafCzSFZOM)), [slides](https://docs.google.com/presentation/d/1xrcd6FEAoNV_NwwO9XV_VTyhgbm9uM-Pn0_ByguE_G0/edit#slide=id.g2c48276719c_1_919), [paper](https://web.ist.utl.pt/~ist190704/sok_security_and_privacy_of_blockchain_interoperability.pdf)
